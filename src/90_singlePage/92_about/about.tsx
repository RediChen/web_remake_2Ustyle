...
const About: FC<IRCProps> = (props) => {
    const over768px = useMediaQuery(rwdFrom('md'));
    return (
        <LayoutSinglePage
            titleEn="About Us"
            titleZh="關於 2Ustyle"
        ...
        >
            ...
            <p>
                ...
                {over768px ? <br /> : <></>}我們希望從前身&nbsp;ecofun2U（把eco &amp; fun帶給你/妳）
                {over768px ? <br /> : <></>}昇華成為一種&nbsp;<b>2U的生活態度，你我的&nbsp;Lifestyle。</b>
            </p>
            <p>
                取名&nbsp;2U，原意是&nbsp;TO YOU，想要把一種「生活態度」帶給你/妳的用意，
                {over768px ? <br /> : <></>}2Ustyle&nbsp;的&nbsp;Logo，是一張充滿希望的笑臉。
            </p>
            <div id="logo-gallery">
